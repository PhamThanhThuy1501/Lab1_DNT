...
const Body=()=>{
  ...
  return(
    <View style={{justifyContent:'center',alignItems:'center' ,flex:1, padding:10, backgroundColor:theme==='light'?'#EEEEEE':'yellow'}}>
      <Banner/>
      ...
      <Block title='Thông tin liên hệ'>
       <Text style={{fontSize:18}}>Vui lòng liên hệ số điện thoại: 0396119561</Text>
      </Block>
